...
architecture a_processador7 of processador7 is
...
begin
    ...
    -- mux de escrita no banco: ULA, constante, MOV, ou RAM
    -- LD usa zero-extension; SUBI usa sign-extension via mux_b_s/cte_ext_s
    ...
    -- SW: endereco = banco_out1 (Rs_addr via reg_r1), dado = banco_out2 (Rs_data via reg_r2)
    -- LW: endereco = banco_out1 (Rs_addr via reg_r1), dado lido vai para data_wr via sel_wr="11"
